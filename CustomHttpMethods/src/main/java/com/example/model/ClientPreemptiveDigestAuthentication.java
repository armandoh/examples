...
public class ClientPreemptiveDigestAuthentication {
	...
	public static void main(String[] args) throws Exception {
		...
		credsProvider.setCredentials(
				...
				new UsernamePasswordCredentials("dev3", "secret"));
		...
		try {
			...
			digestAuth.overrideParamter("realm", "Digest Authentication");
			// Suppose we already know the expected nonce value
			//digestAuth.overrideParamter("nonce", "1392303997939:67f4ed6e6a7d1eb2d44c1c25d799f03e");
			...
			HttpGet httpget = new HttpGet("/CustomHttpMethods/rest/app/hello");
